...
enum DesignHomePreviewFixture {
    ...
    static func makeStore(root: URL) -> UsageStore {
        ...
        let accounts: [Account] = [
            Account(id: "pro20x", name: "pro20x", plan: "pro", proMultiplier: 20,
            ...
            Account(id: "pro5x", name: "pro5x", plan: "pro", proMultiplier: 5,
            ...
            Account(id: "work", name: "工作号", plan: "plus", proMultiplier: nil,
            ...
            Account(id: "collaboration", name: "协作号", plan: "plus", proMultiplier: nil,
            ...
            Account(id: "daily", name: "日常号", plan: "plus", proMultiplier: nil,
            ...
            Account(id: "america", name: "美国号", plan: "plus", proMultiplier: nil,
                creditBalance: "0", membershipUntil: beijingDate(day: 21), membershipNeedsVerification: true,
                fiveHourRemaining: 100, fiveHourReset: beijingDate(day: 23, hour: 6),
                sevenDayRemaining: 45, sevenDayReset: beijingDate(day: 28, hour: 7, minute: 18)),
            Account(id: "personal", name: "个人号", plan: "plus", proMultiplier: nil,
                creditBalance: "0", membershipUntil: nil, membershipNeedsVerification: false,
            ...
            Account(id: "mgr", name: "MGR", plan: "plus", proMultiplier: nil,
        ...
        func quota(_ remaining: Double?, reset: Date?, minutes: Int) -> CodexQuotaWindowSnapshot? {
            ...
            return CodexQuotaWindowSnapshot(RateWindow(
        ...
        let store = UsageStore(
            ...
            snapshot: UsageSnapshot(
                ...
                sevenDayQuota: selected.sevenDay.map {
                    RateWindow(usedPercent: $0.usedPercent,
